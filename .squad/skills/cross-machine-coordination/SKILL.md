...
### For Task Sources (Laptop, Human Tamir)
...
gh issue create \
  ...
  --body "Execute voice cloning on DevBox. Input: s3://squad/voice-input.wav" \
...
artifacts:
  - path: "s3://squad-artifacts/..."   # Location of results
...
**Before (today):**
- Laptop → Tamir manually copies file to Teams chat
- Tamir pastes into DevBox terminal
- Tamir copies DevBox output back
- Tamir pastes result in Teams
