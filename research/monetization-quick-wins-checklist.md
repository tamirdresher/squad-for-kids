...
Dependencies are called out explicitly so you do not hit a wall mid-task.
...
| **itch.io — 14 other games** | Built, NOT published | $0 | In `jellybolt-games/games/` — never uploaded to itch.io |
...
| **YouTube channel** | Status unclear | $0 | 50+ lectures ready, not published |
...
**Why It's Blocked:** Gumroad account exists but Stripe is not connected. No payment can be accepted anywhere.  
**Fix Time:** 15–30 minutes  
**What You Need:** Browser, Gumroad login (`tdsquadai@gmail.com`), Stripe account (create at stripe.com — 5 min with basic identity info)  
...
**Why It's Blocked:** The full catalog of 16 games is built and ready in `jellybolt-games/games/`. Only 2 are published. Dungeon Bolt ($2.99 premium) and 4 PWYW games are sitting on disk earning nothing.  
...
**What You Need:** iPhone 12+ OR Android (Samsung Galaxy), test both landscape and portrait  
**Impact:** Mobile players are the primary audience for Gen Alpha casual games.
...
> Ordered by: Revenue Impact x Ease of completion  
> Items marked [TAMIR] require Tamir's identity — agents cannot complete them.

---

### TIER 1 — Do Today (Revenue Unblocked in Hours)

- [ ] **[TAMIR] Connect Stripe to Gumroad**
...
- [ ] **[TAMIR] Enable PWYW ("Name Your Price") on BrainRot Quiz Battle and Code Conquest**
  ...
  - Dependency: Stripe must be connected first

- [ ] **[TAMIR] Publish Dungeon Bolt ($2.99) to itch.io**
...
- [ ] **[TAMIR] QA mobile black screen fix on real device**
...
- [ ] **[AGENT] Optimize BrainRot Quiz Battle itch.io page**
...
- [ ] **[AGENT] Optimize Code Conquest itch.io page**
...
- [ ] **[AGENT] Create JellyBolt Games collection on itch.io**
  - Go to: https://itch.io/dashboard/collections
  - Create collection: "JellyBolt Games — All Games"
  - Add both published games and link to collection from each game page
  - Time: 10 min
  - Impact: Increases profile visibility and cross-game discovery

- [ ] **[TAMIR] Sign up for ConvertKit (email list)**
  ...
  - Lead magnet PDF ready in: `research/active/monetization-strategy/lead-magnets/`
  - Time: 30-45 min
  - Impact: Email list is your most durable revenue asset — start building it now

- [ ] **[TAMIR] Sign up for Amazon Associates**
  - URL: https://affiliate-program.amazon.com/
  - Add affiliate link to "Rx.NET in Action" book on blog
  - Time: 20 min + 1-3 day approval
  - Impact: Passive income on book/tool recommendations

- [ ] **[AGENT] Publish Rhythm Tap, Neon Snake, Asteroid Dash, Hex Match to itch.io**
...
- [ ] **[AGENT] Publish remaining 9 free games to itch.io**
...
- [ ] **[TAMIR] Confirm YouTube channel is public and monetization-eligible**
  - Check: is the channel public? (not set to private/unlisted)
  - Check: subscriber and watch hour counts (need 1,000 subs + 4,000 hours for ads)
  - If not at threshold: focus on Gumroad cross-sell strategy (more immediate)
  - Time: 10 min
  - Impact: Unblocks content pipeline planning

- [ ] **[AGENT] Add Gumroad product links to blog posts**
  - Add relevant product CTAs at the bottom of existing blog posts
  - .NET posts → link to .NET cheatsheet; AI Squad posts → link to workshop guide
  - Time: 1 hour
  - Impact: Blog traffic → Gumroad sales conversion

- [ ] **[TAMIR] Create "Products" or "Support" page on blog**
  - List: books, digital guides, courses, recommended tools with affiliate links and Gumroad links
  - Time: 1 hour
  - Impact: Evergreen revenue page

- [ ] **[TAMIR] Apply for JetBrains affiliate program**
  - URL: https://www.jetbrains.com/company/partnerships/affiliate/
  - Time: 15 min (3-7 day approval)
...
| Finalize script approval workflow | Tamir/Guinan | Unblocks content pipeline | 1 hour |
...
### Week 3: Cosmetics and Battle Pass MVP
...
### Week 4: Distribution and Discovery
...
| Set up GitHub Sponsors for Squad framework | Tamir | $50-500/month | 30 min |

### Month 2 and Beyond: Scale What's Working
...
- Localize games: Spanish + Portuguese = 2x market size with minimal effort

---

## Section 5: Dependencies

> These are gates. If they are not done, downstream items are blocked.
...
| Action | Why Agent Cannot Do It | Time |
|--------|----------------------|------|
...
- Do NOT build a cosmetics shop before Stripe is connected
- Do NOT run paid ads before organic monetization is confirmed working
- Do NOT build multiplayer infrastructure before mobile is verified working
- Do NOT produce 10 YouTube videos before the channel is confirmed public and optimized
- Do NOT spend time on Discord/community before the core game experience works on mobile
...
*Prepared by Seven, Research and Docs | Issue #908 | March 2026*  
